...
class UNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.cond_layer = nn.Conv2d(in_channels * 2,
    ...
    def forward(self, sample, contitionong, timesteps):
        ...
        sample_cond = torch.concat([sample, contitionong], axis=-3)
        x = self.cond_layer(sample_cond)

...
from utils import normalize_to_neg_one_to_one, unnormalize_to_zero_to_one, numpy_to_pil, match_shape, clip
...
class DDIMScheduler:
    ...
    def generate(self,
        ...
        conditioning = normalize_to_neg_one_to_one(conditioning)

        for t in tqdm(self.timesteps):
            # 1. predict noise model_output
            model_output = model(image, conditioning, t)
